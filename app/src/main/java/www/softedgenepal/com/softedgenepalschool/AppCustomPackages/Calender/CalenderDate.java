...
/**
 * Simple CalenderDate class to store the tuple (year, month, day).
 *
...
public class CalenderDate {
    ...
    /**
     * Create a new CalenderDate instance.
    ...
    /**
     * Create a new CalenderDate instance from Calendar instance.
     * @param calendar Calendar whose data is used to figure out year, month and day values.
     */
    public CalenderDate(Calendar calendar) {
     ...
     */
    public CalenderDate convertToNepali() {
     ...
     */
    public CalenderDate convertToEnglish() { return DateUtils.getEnglishDate(this); }
     ...
     */
    public int getDaysTill(CalenderDate newDate) {
