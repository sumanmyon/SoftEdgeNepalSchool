...
public class StudentHomePage2 implements Contractor.View, ApiCall.ResultListener {
    ...
    public StudentHomePage2(Activity activity, View view) {
    ...
    private void studentDashboard() {
        DashboardCategory category = new DashboardCategory(activity, view, userType) {
            ...
            public void onClickListener(int id) {
                ...
                //nav.set(studentDataCache.RegistrationNo);
            }
        };
